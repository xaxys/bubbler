...
func NewCMinimalSingleGenerator() *CMinimalSingleGenerator {
	return &CMinimalSingleGenerator{}
}

var fileTemplate = `
{{- define "file" -}}
// Target: C-Minimal Single File
...
func (g *CMinimalSingleGenerator) generateType(type_ definition.Type) (def string) {
...
func (g *CMinimalSingleGenerator) generateStruct(structDef *definition.Struct) *GeneratedType {
...
func (g *CMinimalSingleGenerator) generateStructMethods(structDef *definition.Struct) string {
	funcMap := template.FuncMap{
...
func (g *CMinimalSingleGenerator) generateExpr(expr definition.Expr, valueReplacement string) string {
	funcMap := template.FuncMap{
		"generateExpr": g.generateExpr,
		"generateType": g.generateType,
	}
...
func (g *CMinimalSingleGenerator) generateEnum(enumDef *definition.Enum) *GeneratedType {
...
func (g *CMinimalSingleGenerator) generateEncoder(structDef *definition.Struct) string {
...
func (g *CMinimalSingleGenerator) generateDecoder(structDef *definition.Struct) string {
