...
/**
 * Creates an array and initializes each entry with a factory callback.
 * @function createArray
 * @description Creates an array and initializes each entry with a factory callback.
 * @param {Number} length Number of elements to allocate.
 * @param {Function} init Factory called once for each index.
...
/**
 * Converts a JS number into IEEE-754 float32 raw bits.
 * @function floatToUint32Bits
 * @description Converts a JS number into IEEE-754 float32 raw bits.
 * @param {Number} value Float value.
 * @returns {Number} Unsigned 32-bit bit pattern.
 */
...
/**
 * Converts a float32 bit pattern back into a JS number.
 * @function uint32BitsToFloat
 * @description Converts a float32 bit pattern back into a JS number.
 * @param {Number} value Unsigned 32-bit bit pattern.
...
/**
 * Converts a JS number into IEEE-754 float64 raw bits.
 * @function doubleToUint64Bits
 * @description Converts a JS number into IEEE-754 float64 raw bits.
 * @param {Number} value Double value.
 * @returns {BigInt} Unsigned 64-bit bit pattern.
 */
...
/**
 * Converts a float64 bit pattern back into a JS number.
 * @function uint64BitsToDouble
 * @description Converts a float64 bit pattern back into a JS number.
 * @param {BigInt} value Unsigned 64-bit bit pattern.
...
/**
 * Calculates the UTF-8 byte count of a JS string.
 * @function stringToUTF8BytesCount
 * @description Calculates the UTF-8 byte count of a JS string.
 * @param {String} str Source text.
 * @returns {Number} Number of bytes required in UTF-8.
 */
...
/**
 * Encodes a JS string into UTF-8 bytes.
 * @function stringToUTF8Bytes
 * @description Encodes a JS string into UTF-8 bytes.
 * @param {String} str Source text.
 * @param {Array|Uint8Array} data Output buffer.
 * @param {Number} start Start position in output buffer.
...
/**
 * Decodes UTF-8 bytes into a JS string until a zero terminator is found.
 * @function stringFromUTF8Bytes
 * @description Decodes UTF-8 bytes into a JS string until a zero terminator is found.
 * @param {Array|Uint8Array} data Input buffer.
 * @param {Number} start Start position in input buffer.
 * @returns {Array} Tuple of [decoded string, consumed byte count].
 */
...
class {{ $structDef.StructName }} {
    /**
     * Initialize {{ $structDef.StructName }} object with generated default values.
     * @function constructor
     * @memberof {{ $structDef.StructBelongs.Package }}.{{ $structDef.StructName }}
     * @instance
     * @param {Object<string, any>} [properties] Optional initial field values.
     */
    ...
    /**
     * Create {{ $structDef.StructName }} object with optional initial field values.
     * @function create
     * @memberof {{ $structDef.StructBelongs.Package }}.{{ $structDef.StructName }}
     * @static
     * @param {Object<string, any>} [properties] Optional initial field values.
     * @returns {{ "{" }}{{ $structDef.StructName }}{{ "}" }} {{ $structDef.StructName }} object.
     */
    ...
    /**
     * Indicates whether {{ $structDef.StructName }} contains dynamic-length fields.
     * @function dynamic
     * @memberof {{ $structDef.StructBelongs.Package }}.{{ $structDef.StructName }}
     * @static
     * @returns {Boolean} True for dynamic-size struct, otherwise false.
     */
    static dynamic() {
    ...
    /**
     * Calculate fixed static size of {{ $structDef.StructName }} object.
     * @function size
     * @description Returns the fixed static size in bytes (excluding dynamic payload).
     * @memberof {{ $structDef.StructBelongs.Package }}.{{ $structDef.StructName }}
     * @static
     * @returns {Number} Fixed static size of {{ $structDef.StructName }} object.
     */
    static size() {
