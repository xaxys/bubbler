...
func (g *CSingleGenerator) generateType(type_ definition.Type) (def string) {
...
func (g *CSingleGenerator) generateStruct(structDef *definition.Struct) *GeneratedType {
...
func (g *CSingleGenerator) generateStructMethods(structDef *definition.Struct) string {
	funcMap := template.FuncMap{
...
func (g *CSingleGenerator) generateExpr(expr definition.Expr, valueReplacement string) string {
	funcMap := template.FuncMap{
		"generateExpr": g.generateExpr,
		"generateType": g.generateType,
	}
...
func (g *CSingleGenerator) generateEnum(enumDef *definition.Enum) *GeneratedType {
...
func (g *CSingleGenerator) generateDecoder(structDef *definition.Struct) string {
