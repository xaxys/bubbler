...
func ExecuteTemplate(templ, templateName string, fns template.FuncMap, data interface{}) string {
	...
	fns["indent"] = func(n int, v any) string { return IndentSpace(v, n) }
	fns["indentspace"] = func(n int, v any) string { return IndentSpaceNoFirst(v, n) }
	fns["slice"] = templateSlice
	fns["split"] = templateSplit
...
func templateSplit(str interface{}, sep interface{}) []string {
	return strings.Split(fmt.Sprint(str), fmt.Sprint(sep))
}
